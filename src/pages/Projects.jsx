...
const Projects = () => {
  ...
  return (
    <div id='projects' className='flex flex-col mx-auto mt-20 bg-back space-y-20 justify-center items-center px-8'>
        <h1 className='text-3xl font-bold text-card'>My <span className='text-orange'>Projects</span></h1>
        <div id='projectsWrapper' className='flex flex-row flex-wrap justify-evenly mt-20 gap-y-20 gap-x-10 items-center max-sm:gap-y-16 max-sm:gap-x-0'>
          ...
          <ProjectCard text='Zeraki School Management' description='A fullstack web app that employs MERN (MongoDB,ExpressJS,ReactJS,NodeJS) to facilitate creating, reading, updating and deleting of books in a library.Utilizes HTTP requests for data handling' image="/Zeraki.png" languages={['ReactJS',', NodeJS',', Express',', TailwindCSS']}/>
