...
const FigmaProjects = () => {
  return (
    <div className="flex flex-row flex-wrap justify-evenly max-sm:justify-center max-sm:items-center mt-20 gap-y-20 gap-x-10 items-center max-sm:gap-y-16 max-sm:gap-x-0 p-8">
      ...
      <FigmaComponents count={2} link="https://www.figma.com/proto/NFXuIk00E0mpRvzNYYOLNH/MPESA?node-id=102-73&t=g1SDxSK2qGEIkoE6-1&scaling=scale-down&content-scaling=fixed&page-id=102%3A72" text="MPESA App" projectImage="/image3.jpg" description="A UI design for a revamped M-PESA screen" icon={<FaFigma />} ></FigmaComponents>
