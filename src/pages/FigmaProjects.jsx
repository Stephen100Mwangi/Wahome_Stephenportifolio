...
const FigmaProjects = () => {
  return (
    <div className="flex flex-row flex-wrap justify-center items-center gap-x-20 gap-y-20 max-sm:gap-y-24 max-sm:gap-x-0">
      ...
      <FigmaComponents count={6} link="https://www.figma.com/proto/O4kE8YyxIzHn1HY0YC2MsN/Hello-Tractor?node-id=1-20&node-type=canvas&t=f3inhJYvLFCo57jQ-1&scaling=scale-down&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=1%3A20&show-proto-sidebar=1" text="Hello Tractor - Operator App" projectImage="public\tractor.png" description="A UI design for Hello Tractor OPerator app" icon={<FaFigma />} ></FigmaComponents>
      <FigmaComponents count={7} link="https://www.figma.com/proto/2BHwFVk561d9mTAh3CYzwj/ELP_Linker?node-id=3-7&node-type=canvas&t=P75IvV0nIwFY67Bu-1&scaling=scale-down&content-scaling=fixed&page-id=3%3A6&starting-point-node-id=3%3A7" text="ELP linker" projectImage="public\epl.png" description="A UI design for a website to link clients with service providers" icon={<FaFigma />} ></FigmaComponents>
    </div>
  )
}
