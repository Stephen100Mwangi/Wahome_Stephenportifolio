...
const FigmaComponents = ({text, projectImage, count, description, icon, link}) => {
  return (
    <div className='w-[400px] relative min-h-[500px] items-center justify-center hover:shadow-2xl flex flex-col space-y-5 shadow-lg rounded-lg p-5 bg-cardColor'>
        ...
        <a  target='_blank' href={link} className='text-xs text-center p-3 px-4 rounded-sm hover:rounded-full bg-card text-white cursor-pointer'>View Prototype</a>
    </div>
  )
}
